...
The 42-year half-life, while a useful summary statistic, is a theoretical extrapolation that assumes a constant convergence rate and should not be interpreted as a forecast. As a sensitivity, we re-fitted the same log-linear beta-convergence specification on shorter, more recent windows. Restricted to 2005--2021 (post the rapid 1990s convergence), the half-life lengthens to approximately 54 years; restricted to 2010--2021, it lengthens further to approximately 84 years. The early subperiod 1990--2005 yields a faster 33-year half-life. The 42-year full-period estimate therefore weights the rapid 1990s convergence and substantially understates the current pace; the most recent decade indicates that, conditional on continuation of the present trajectory, convergence is operating at roughly half the speed implied by the headline figure. Under any of these assumptions, achieving equitable DS-TB care quality by the 2030 End TB Strategy deadline would require substantially accelerated convergence relative to the historical pace.
...
However, the pace of convergence is concerning. The full-period estimate of a 42-year half-life is dominated by rapid 1990s convergence; restricted to the more recent 2005--2021 or 2010--2021 windows, the implied half-life lengthens to roughly 54 and 84 years respectively. Whichever window is used, substantial inequality will persist well beyond 2030, and the recent-window estimates suggest the gap is closing materially more slowly than the headline figure implies, underscoring the need for accelerated investment in low-performing settings.
...
This analysis demonstrates that inequality in DS-TB care quality across 195 countries is declining on most relative measures, but the pace is slow (full-period convergence half-life of 42 years; recent-window 2005--2021 estimate $\sim$54 years) and absolute inequality remains unchanged. Case fatality disparity is the largest contributor to the structural decomposition of wealth-related inequality, accounting for 40\% of the Concentration Index by construction. Gender inequality favours females in virtually all countries but is most pronounced in low-SDI settings, and age-related inequality disproportionately affects children under 5 years in less developed contexts.
